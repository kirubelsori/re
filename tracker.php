...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
       <li class="active" ><a href="tracker.php">    DevP tracker </a></li>
      ...
      <section>
        ...
        <div class="breadcrumbs-custom context-dark bg-overlay-60">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">DevTracker</h2>
            <ul class="breadcrumbs-custom-path">
            </ul>
          </div>
          <div class="box-position" style="background-image: url(images/5361810.jpg);"></div>
        </div>
      </section>
        ...
        <p style="font-size:20px;" align="left" >Project performance and systematic measurement of results and impacts in development projects is vital. If you don't have one of these tools, don't worry we got you back. ReLink will develop low cost high quality expert level digital monitoring and evaluation (M&E) and results measurement tools. 
		</p>
		</br>
   ...
   <article class="title-classic">
            ...
            <div class="title-classic-title">
              <h5> Example of the tools</h5>
            </div></br>
            <div class="title-classic-text">
              <p>Project performance tracking tool | Market systems change tracker | Project results analytics | Business performance tracker | Database development</p>

			</div>
          </article>
		              			  <img src="images/tracker1.jpg" width="60%" height="30%"></img>            
        ...
        <div class="container">
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  <div>
				  <h5>Project performance tracking tool</h5></div>
         ...
         <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  <div>
              <h5> Market systems change tracker</h5>
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"></p>
                </div>
              </article>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  <div>
				  <h5>Project results analytics</h5></div>
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"></p>
                </div>
              </article>
			...
			<div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  <div>
				  <h5>Business performance tracker</h5></div>
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"></p>
                </div>
              </article>
			...
			<div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  <div>
				  <h5>Database development</h5></div>
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"></p>
                </div>
              </article>
            </div>
		              			  <img src="images/tracker3.jpg" width="60%" height="30%"></img>            
